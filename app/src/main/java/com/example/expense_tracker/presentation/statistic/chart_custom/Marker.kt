package com.example.expense_tracker.presentation.statistic.chart_custom
...
internal fun rememberMarker(
    ...
    return remember(label, indicator, guideline, isMonth) {
        object : MarkerComponent(label, indicator, guideline) {
            init {
                ...
                labelFormatter = CustomMarkerLabelFormatter(isMonth = isMonth)
            }
