...
private val DarkColorScheme = ReplacementColorScheme(
    ...
    onBottomNavigationBackground = Color.White,
    onBottomNavigationBackgroundFilled = Color(0xFFa0d0cd),
...
private val LightColorScheme = ReplacementColorScheme(
    ...
    onBottomNavigationBackground = Color.Black,
    onBottomNavigationBackgroundFilled = DarkGreen,
